                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.slider') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($homeslide->home_slide)) ? url('upload/admin_images/'.$homeslide->home_slide) : url('upload/admin_images/no_image.jpg') }}" alt="Card image cap">
                                </div>
                            </div>
                            <!-- end row -->
